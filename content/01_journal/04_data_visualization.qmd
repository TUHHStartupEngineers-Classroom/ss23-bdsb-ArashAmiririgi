...
mortality_rate <- covid_data_tbl %>% select(continent, location, new_deaths, population) %>%
...
## ggplot ----
suppressWarnings(ggplot() + geom_map(data = combined_data, map = world,
